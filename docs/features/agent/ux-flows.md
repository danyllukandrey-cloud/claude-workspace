...
> ⚠️ **SCR-01 Entry/Exit застаріли 2026-09-14 ([D-121](../../DECISIONS.md#d-121)).** Чат більше не "екран", на який заходять/з якого виходять — постійна панель, видима одночасно з будь-яким іншим напрямком. Каркас — [`docs/app-shell.md`](../../app-shell.md). Purpose (внутрішні стани й діалогові потоки нижче) лишається чинним, змінився лише контейнер.
