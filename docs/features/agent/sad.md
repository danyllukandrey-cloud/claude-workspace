...
- Числове значення цільової точності дотримання власного правила (AC-07) → ≥ 95%, вимірюється протягом 90 днів після запуску (§10 QG-1, закрито 2026-08-27, уточнення з Андрієм).
