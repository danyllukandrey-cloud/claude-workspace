...
Короткий покажчик: коли яку команду вводити і що вона робить. Повні інструкції живуть у файлах-джерелах (посилання в таблиці нижче) — тут навмисно без дублювання тексту, лише карта потоку.
...
Окремо, не прив'язано до git-подій: **`/pm-start`** — план на сьогодні, вводиш вручну, коли він потрібен.
