...
> `implement` матеріалізує цей план у реальний код через `docs/features/_scaffold/tasks.json`.
>
...
- Групування карток на рівні Структури (D-29) спроєктоване на рівні рішення, конкретний UI (клітинки, перетягування) ще не реалізований — деталі в [design-review.md](../docs/features/life-area-card/design-review.md), блок 4
