...
| База на бекенді | сервер-проксі (D-24) | `plan/app/src/shared/backend/` (заготовка) | Джерело правди для синхронізації між пристроями; без жорсткого ліміту, на відміну від кешу |
