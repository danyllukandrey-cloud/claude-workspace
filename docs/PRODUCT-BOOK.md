...
**Стан:** Фаза 1 (написання) завершена повністю 2026-08-23. Блоки 1 «Проєкт», 2 «Структура», 3 «Картка», 4 «Агент», 5 «Інстанс», 6 «Філософія» написано й вичитано 2026-08-21/22. Розділ «Мовою професій» (п.8, ПРОД-1) — 4 профілі (топ-менеджер, програміст, філософ, педагог — психотерапевта прибрано), затверджено 2026-08-23.
