...
**Стан:** у роботі. Блоки 1 «Проєкт» (окрім п.8), 2 «Структура», 3 «Картка», 4 «Агент», 5 «Інстанс», 6 «Філософія» написано й вичитано 2026-08-21/22. Розділ «Мовою професій» (п.8, ПРОД-1) переписано 2026-08-22 до 4 профілів (топ-менеджер, програміст, філософ, педагог — психотерапевта прибрано), але поточний текст Андрію **не подобається**, доробка не завершена.

**⚠️ Обов'язково на початку наступної сесії:** повернутись до розділу «Мовою професій» (п.8 блоку 1) і доробити його з Андрієм, перш ніж рахувати Фазу 1 (написання книги) завершеною і переходити до Фази 2.
...
**Топ-менеджер.** Сервіс ПЛАН — це інструмент, що дає можливість оцінити ключові аспекти життя на стратегічному рівні. Він дає можливість управляти ключовими зонами життя. Сервіс ПЛАН показує прогрес в кожному окремому напрямку, ілюструє як ці напрямки між собою взаємодіють та конкурують. Він дає можливість оцінити реальну картину прогресу та співвідношення між аспектами відносно декларованої. Цей сервіс — сервіс менеджменту різних зон відповідальності в житті з можливістю побудови ефективного та збалансованого плану, що підтверджується зібраними метриками його виконання.

**Програміст.** ПЛАН — інструмент, що дає змогу подивитись на ключові домени життя. Він дає можливість керувати ними, показує прогрес у кожному окремому парметрі, ілюструє, як виміри між собою взаємодіють і конкурують за спільні ресурси — час, увагу. Він дає можливість побачити реальний стан прогресу і співвідношення між доменами відносно задекларованого. Цей сервіс — система управління різними доменами відповідальності в житті з можливістю зібрати ефективний і збалансований план, підтверджений телеметрією — зібраними метриками виконання.

**Філософ.** ПЛАН — інструмент, що дає змогу побачити ключові грані існування з висоти цілого життя. Він дає можливість узгоджувати ці грані буття між собою. ПЛАН показує рух у кожній окремій грані, ілюструє, як ці грані суперничають одна з одною за одне й те саме обмежене — час, увагу, силу. Він дає можливість побачити, ким людина є за фактом, відносно того, ким вона себе оголосила. Це не менеджмент — це спроба звести грані свого існування в щось цілісне й збалансоване, підтверджене не відчуттям, а фактом.

**Педагог.** ПЛАН — це інструмент, що дає можливість керувати аспектами свого життя. Він дає можливість побачити реальну успішність. Сервіс вказує на різницю між реальним станом справ відносно заявлених цілей. Це не оцінювання — це побудова збалансованого життєвого плану, з чіткою, зрозумілою системою збору метрик.

*Сформульовано в діалозі з Андрієм 2026-08-22, за завданням ПРОД-1 ([DELIVERY-PLAN.md](DELIVERY-PLAN.md#прод-1--опис-продукту-словником-3-5-різних-професій)); 4 профілі, Андрій дороблює текст.*
