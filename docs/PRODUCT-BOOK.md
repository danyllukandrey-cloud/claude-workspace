...
**Стан:** у роботі. Блоки 1 «Проєкт», 2 «Структура», 3 «Картка», 4 «Агент», 5 «Інстанс», 6 «Філософія» написано й вичитано 2026-08-21/22. Розділ «Мовою професій» (ПРОД-1) написано начорно 2026-08-22 — зараз Андрій читає й дороблює його до кінця. Це завершує Фазу 1 (написання книги); далі — Фаза 2 (правка існуючих документів за книгою).
...
**Топ-менеджер.** ПЛАН зводить розкидане життя людини в одну картину прогресу. Він чесно показує розрив між тим, що людина про себе заявила, і тим, що показують факти.

**Програміст.** Одна універсальна картка приймає дані з прямого вводу (текст, голос, будь-яке вкладення) і зовнішніх інтеграцій, і нормалізує їх до однакових метрик. Оцінка (прогрес, розрив) рахується окремим шаром аналітики над картками, а не в кожній з них. Порядок карток у структурі — єдине джерело правди для пріоритету.

**Філософ.** ПЛАН — дзеркало, а не суддя: він показує розрив між тим, ким людина себе оголосила, і тим, ким є за фактом. Оцінка не втішає й не картає — вона просто є, рішення діяти лишається за людиною. Порядок карток у схемі — видима сповідь про те, що насправді головне.

**Психотерапевт.** ПЛАН підсвічує розрив між тим, що людина каже собі про себе, і тим, як вона насправді живе — без діагнозу й без поради, тільки факт, з яким людина сама вирішує, що робити. Це дзеркало для роботи над собою, не терапія й не заміна фахівця.

**Педагог.** ПЛАН не дає готових відповідей — показує людині її ж дані і дає їй самій зробити висновок, спираючись за потреби на рекомендовані школи та методики. Найкраще навчання — самостійно побачити розрив і захотіти його закрити.

*Сформульовано в діалозі з Андрієм 2026-08-22, за завданням ПРОД-1 ([DELIVERY-PLAN.md](DELIVERY-PLAN.md#прод-1--опис-продукту-словником-3-5-різних-професій)).*
