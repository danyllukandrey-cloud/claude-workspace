      ...
      <div className="flex w-full max-w-md flex-col items-center gap-8 text-center">
        ...
        <div className="flex flex-col gap-3 text-left">
          ...
          <p className="text-sm italic text-ink-muted">
            Цей застосунок допоможе осмислити важливі сфери життя, сформулювати власне бачення та скласти план руху
            вперед. Тут навмисне немає обліку дрібних завдань, в центрі уваги цілі аспекти — навчання, кар'єра,
            здоров'я, стосунки та інші напрями, які ви оберете.
          </p>
          <p className="text-sm italic text-ink-muted">
