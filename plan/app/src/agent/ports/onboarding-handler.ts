...
// текст (t24-ports-onboarding.md Notes). Уточнено живим тестуванням
// 2026-09-14 -- Андрій дав конкретний текст цієї заглушки, я лише вичитав
// орфографію/пунктуацію (правки: "AI агент" -> "агент", без англіцизму, не
// вживається більше ніде в продукті; кома після вставного "Якщо потрібно";
// "будь який момеент" -> "будь-який момент", дефіс + одруківка).
//
...
const WELCOME_MESSAGE_CONTENT =
  ...
  'Я твій агент.\n' +
  '\n' +
  'Моїм головним завданням є допомога в роботі з сервісом.\n' +
  '\n' +
  'Яку метрику, дію чи процес ти хочеш записати?\n' +
  'Якщо потрібно, я підкажу, в яку картку додати метрику чи яку картку створити.\n' +
  'Запитуй, я відповім та допоможу в будь-який момент.';
