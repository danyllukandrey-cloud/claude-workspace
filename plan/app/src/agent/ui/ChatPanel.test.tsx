// T26 -- чат-панель (докладніше ChatPanel.tsx; D-121 перейменував зі
// ChatScreen/SCR-01, докстрінг компонента), spec.md AC-01/02/02b/03/04/05/09/
// 10/10b/13/15. Component test: default/empty-onboarding/loading/proposal-
...
// Стани перевіряються незалежно від D-121-обгортки (розгорнута/згорнута) --
// той самий контент, лише CSS-видимість (докстрінг ChatPanel.tsx).

import { render, screen, waitFor, fireEvent } from '@testing-library/react';
import { describe, it, expect, vi } from 'vitest';
import { ChatPanel, CONFIRMED_HINT_TEXT } from './ChatPanel';
...
describe('ChatPanel -- empty-onboarding (AC-13)', () => {
...
describe('ChatPanel -- default (history loaded, no active proposal)', () => {
...
describe('ChatPanel -- clarifying (AC-04/AC-05, no proposal)', () => {
...
describe('ChatPanel -- proposal-pending (AC-01/AC-02/AC-10)', () => {
...
describe('ChatPanel -- confirmed (AC-02)', () => {
...
describe('ChatPanel -- confirmed-hint (AC-16/AC-16b, T47)', () => {
...
describe('ChatPanel -- error banners (AC-10b/AC-19b, §8 rate limit, sad.md §6 Flow 2)', () => {
