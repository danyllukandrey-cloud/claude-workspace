...
Сервіс, у якому користувач описує власні життєві напрямки й веде їх у часі. Складається
із застосунку та сайту.

Для кого продукт і яку задачу знімає — [Product Brief](docs/Product_Overview/Product_Brief.md).
Модель, принципи й напрямок розвитку — [Product Vision](docs/Product_Overview/Product_Vision.md).
