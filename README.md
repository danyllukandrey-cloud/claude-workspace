...
Сервіс, у якому користувач описує власні життєві напрямки й веде їх у часі. Складається із застосунку та сайту.
...
Повний перелік — 34 файли, згруповані за темою. У кожного один рядок: назва, посилання, одне речення про що він. Хто з чим пов'язаний — дивись «Карту власників» у [CLAUDE.md](CLAUDE.md), тут це навмисно не повторюємо.
